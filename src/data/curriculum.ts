          ...
          books: [
            {
              ...
              sections: [
                ...
                { id: 'iliad-2', title: 'Book II', hasText: true, hasQuestions: true, meta: { estLength: '~34 min' } },
                { id: 'iliad-3', title: 'Book III', hasText: true, hasQuestions: true, meta: { estLength: '~18 min' } },
                { id: 'iliad-4', title: 'Book IV', hasText: true, hasQuestions: true, meta: { estLength: '~22 min' } },
                { id: 'iliad-5', title: 'Book V', hasText: true, hasQuestions: true, meta: { estLength: '~37 min' } },
                { id: 'iliad-6', title: 'Book VI', hasText: true, hasQuestions: true, meta: { estLength: '~22 min' } },
                { id: 'iliad-7', title: 'Book VII', hasText: true, hasQuestions: true, meta: { estLength: '~19 min' } },
                { id: 'iliad-8', title: 'Book VIII', hasText: true, hasQuestions: true, meta: { estLength: '~23 min' } },
                { id: 'iliad-9', title: 'Book IX', hasText: true, hasQuestions: true, meta: { estLength: '~30 min' } },
                { id: 'iliad-10', title: 'Book X', hasText: true, hasQuestions: true, meta: { estLength: '~24 min' } },
                { id: 'iliad-11', title: 'Book XI', hasText: true, hasQuestions: true, meta: { estLength: '~37 min' } },
                { id: 'iliad-12', title: 'Book XII', hasText: true, hasQuestions: true, meta: { estLength: '~21 min' } },
                { id: 'iliad-13', title: 'Book XIII', hasText: true, hasQuestions: true, meta: { estLength: '~36 min' } },
                { id: 'iliad-14', title: 'Book XIV', hasText: true, hasQuestions: true, meta: { estLength: '~23 min' } },
                { id: 'iliad-15', title: 'Book XV', hasText: true, hasQuestions: true, meta: { estLength: '~32 min' } },
                { id: 'iliad-16', title: 'Book XVI', hasText: true, hasQuestions: true, meta: { estLength: '~39 min' } },
                { id: 'iliad-17', title: 'Book XVII', hasText: true, hasQuestions: true, meta: { estLength: '~32 min' } },
                { id: 'iliad-18', title: 'Book XVIII', hasText: true, hasQuestions: true, meta: { estLength: '~26 min' } },
                { id: 'iliad-19', title: 'Book XIX', hasText: true, hasQuestions: true, meta: { estLength: '~17 min' } },
                { id: 'iliad-20', title: 'Book XX', hasText: true, hasQuestions: true, meta: { estLength: '~22 min' } },
                { id: 'iliad-21', title: 'Book XXI', hasText: true, hasQuestions: true, meta: { estLength: '~27 min' } },
                { id: 'iliad-22', title: 'Book XXII', hasText: true, hasQuestions: true, meta: { estLength: '~24 min' } },
                { id: 'iliad-23', title: 'Book XXIII', hasText: true, hasQuestions: true, meta: { estLength: '~39 min' } },
                { id: 'iliad-24', title: 'Book XXIV', hasText: true, hasQuestions: true, meta: { estLength: '~36 min' } },
              ],
            },
            {
              id: 'homer-odyssey',
